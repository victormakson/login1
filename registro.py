...
class Login(BoxLayout):
    def __init__(self, arg1=None, arg2=None, **kwargs):
        ...
        self.add_widget(Label(text="Cadastro", font_size=50, font_name='Impact', color=get_color_from_hex('#000000')))
        self.add_widget(Label(text="Faça seu Cadastro!", font_size=20, font_name='Arial', color=get_color_from_hex('#000000')))
